...
(async () => {
    program.command('start')
        ...
        .option('--discovery-host <dnsDiscoveryHost>', 'The host on which the peers will discovery through.', '127.0.0.1')
        .option('--discovery-port <dnsDiscoveryPort>', 'The port on which the peers will discover through.', '16001')
        .option('--dns-host <dnsServerHost>', 'The host of the DNS server to query to get the other peers.', '127.0.0.1')
        .option('--dns-port <dnsServerPort>', 'The port on the DNS server to query to get the other peers.', '53')
